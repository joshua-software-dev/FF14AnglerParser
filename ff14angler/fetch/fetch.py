...
class Fetch:
    ...
    async def main(driver: WebDriver):
        ...
        for angler_bait_id, bait_data in homepage_data['bait'].items():
        ...
        for angler_fish_id, fish_data in homepage_data['fish'].items():
        ...
        for angler_spot_id, spot_data in homepage_data['spot'].items():
