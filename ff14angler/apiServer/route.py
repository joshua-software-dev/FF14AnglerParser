...
def register_routes(app: falcon.API, db_engine: Engine):
    ...
    routes: Dict[str, Type[resource.LimitedCollectionResource]] = {
        ...
        '/bait/name/{language}/{name}': resource.BaitCollectionResource,
        ...
        '/fish/name/{language}/{name}': resource.FishCollectionResource,
        ...
        '/spot/name/{language}/{name}': resource.SpotCollectionResource,
